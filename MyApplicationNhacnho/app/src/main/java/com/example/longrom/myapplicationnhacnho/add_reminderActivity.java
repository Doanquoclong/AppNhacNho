...
public class add_reminderActivity extends AppCompatActivity {
    ...
    public void setTime(View v){
        ...
        TimePickerDialog tpd = new TimePickerDialog(
                this,android.R.style.Theme_Holo_Light_Dialog_MinWidth,mtimesetlistener,
    ...
    public void saveReminder(){
        ...
        if (mActive.equals("true")) {
            if (mRepeat.equals("true")) {
                new AlarmReceiver().setRepeatAlarm(this, mCalendar, ID, mRepeatTime);
